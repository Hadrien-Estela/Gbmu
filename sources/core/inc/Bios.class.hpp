...
//                                                +#+#+#+#+#+   +#+           //
//   Created: 2016/01/18 15:32:08 by hestela           #+#    #+#             //
//   Updated: 2016/01/18 15:32:33 by hestela          ###   ########.fr       //
//                                                                            //
// ************************************************************************** //

#ifndef BIOS_CLASS_HPP
# define BIOS_CLASS_HPP
...
/*
	this is the bootable internal Rom program
*/
...
namespace Gbmu
{
	...
	class Bios
	{
		...
		private:
			Cpu*			_cpu; // get pointer to cpu ( the parent )
			const uint8_t	_dmgBios[0x100] = {
